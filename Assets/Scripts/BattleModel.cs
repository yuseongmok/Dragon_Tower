...
namespace DragonTower
{
    ...
    public sealed class BattleStats
    {
        ...
        public float criticalChance=0,criticalDamage=1.5f;
    ...
    public sealed class BattleModel
    {
        ...
        double shieldUntil,burnUntil,burnNext,slowUntil,rapidUntil,firstAidUntil,frostBarrierReady;float slowPercent;
        bool firstAidUsed,dodgeAttemptedForStrike;
        ...
        public bool Skill()
        {
            ...
            SkillReady = Time + Math.Max(0,Dragon.skill.cooldown)*(Time<firstAidUntil?.5f:1f);
        ...
        int Hit(int baseDamage,ElementType element,bool skill,out bool critical)
        {
            ...
            float chance=Dragon.criticalChance*100f;if(EnemyBurning&&Has(AugmentMechanic.Inferno))chance+=Value(AugmentMechanic.Inferno,50);
